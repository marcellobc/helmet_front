...
function NavBar(props) {
  ...
  const { loggedUser } = session.getData();
    ...
    // },
    {
      ...
      icon: {
        desktop: (
          <GroupWorkIcon
            className={
              selectedTab === "Groups" ? classes.textPrimary : "text-white"
            }
            fontSize="small"
          />
        ),
        mobile: <GroupWorkIcon className="text-white" />,
      },
    },
    {
      link: "/c/users",
        ...
        <Toolbar className={classes.appBarToolbar}>
          ...
          >
            ...
            >
              <Avatar
                alt="profile picture"
                src={`${process.env.PUBLIC_URL}/images/logged_in/profilePicture.png`}
