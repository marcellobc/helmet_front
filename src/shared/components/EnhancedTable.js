        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              order={order}
              orderBy={orderBy}
              onSelectAllClick={allowSelection ? handleSelectAllClick : null}
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      onClick={(event) =>
                        allowSelection && handleClick(event, row.name)
                      }
                      role="checkbox"
                    ...
                    >
                      ...
                      {columns.map((c) => {
                        if (c.id === "actions") {
                          ...
                          let content = "";
                          if (c.render) {
                            content = c.render(row, value);
                          } else if (value) {
                            if (c.format) {
                              content = formatter[c.format](value);
                            } else {
                              content = value;
                            }
                          }
                          ...
                          return (
                            <TableCell align={c.align}>{content}</TableCell>
                          );
                        }
                      })}
                    </TableRow>
